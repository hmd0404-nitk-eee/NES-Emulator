...
olc::Sprite& Nes_Em_2C02::GetScreen()
{
...
olc::Sprite& Nes_Em_2C02::GetPatternTable(uint8_t i, uint8_t palette)
{
...
olc::Pixel& Nes_Em_2C02::GetColourFromPaletteRam(uint8_t palette, uint8_t pixel)
{
...
olc::Sprite& Nes_Em_2C02::GetNameTable(uint8_t i)
{
...
uint8_t Nes_Em_2C02::cpuRead(uint16_t addr)
{
	uint8_t data = 0x00;
	switch (addr)
	{
...
void Nes_Em_2C02::cpuWrite(uint16_t addr, uint8_t data)
{
	switch (addr)
	{
	case 0x0000: // Control
...
uint8_t Nes_Em_2C02::ppuRead(uint16_t addr)
{
	uint8_t data = 0x00;
	addr &= 0x3FFF;
...
void Nes_Em_2C02::ppuWrite(uint16_t addr, uint8_t data)
{
	addr &= 0x3FFF;
...
void Nes_Em_2C02::ConnectCartridge(const std::shared_ptr<Cartridge>& cartridge)
{
	this->cart = cartridge;
}

void Nes_Em_2C02::reset()
{
	fine_x = 0x00;
	address_latch = 0x00;
